...
- マスターデータ: `scripts/data/midi/export_licks.mid` (Cubase一括書出し、トラック名=ファイル名規約)
- マルチトラックモード: `python scripts/parse_licks.py scripts/data/midi/export_licks.mid` (2トラック以上で自動判定)
- 個別ファイルモード: `python scripts/parse_licks.py scripts/data/midi/` (従来互換)

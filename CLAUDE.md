...
- フレーズジェネレーター: リック検索型アーキテクチャ (selectLick→resolveLick、5リトライ)、リックライブラリ (~11,000リック、LBDM+MLA+DTL抽出)、可変リズム (4分/3連/8分/16分)、拍数選択 (2/3/4拍)、ゴールノート選択 (指板クリック)、コード間VL+モチーフ記憶、SVG曲線表示、単体再生 (▶ Play)

...
**テスト**: 43テスト (リック検索型) + 1テスト (品質監査プレースホルダー) + 41テスト (ルールベース: segments 11 + templates 11 + generator 19) + 29テスト (分析)
...
- 拍位置ベース品質チェック: CT表拍配置率 ≥ 40%, 音域 4-15半音, 跳躍 ≤ 9半音

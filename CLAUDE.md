...
- 出力: `scripts/data/licks.generated.json` — `{ type: [{ notes, noteCount, beats, source?, anacrusis? }] }`
...
- 個別ファイルモード: `python scripts/parse_licks.py scripts/data/midi/licks/` (従来互換)
...
- 入力: `scripts/data/midi/drums/{style}_{番号}.mid` (8小節=32拍, 4/4, 任意BPM)
- キットマッピング: `scripts/data/midi/drums/drum-kits.json` (スタイル → キットフォルダ名)

...
├── types/
│   └── music.ts                     — ChordSlot, Progression, ChartMeasure, ChartLayout, ModeTemplate, VoicingTemplate, FoundVoicing 等
├── constants/
...
- コードフォーム表示: Drop 2 / Drop 3 ボイシング (20テンプレート)、指板ハイライト、◀/▶ 切替
  - **⚠ 未検証**: UI動作確認が未実施。別PCでの検証が必要

---

## 今後の開発予定

1. コードフォーム機能の検証・改善 (UI動作確認、視認性調整)
2. ポジション間移動ガイド (共通音ハイライト)
3. 音声再生 (Web Audio API)

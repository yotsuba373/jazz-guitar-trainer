...
│       ├── phraseQualityAudit.test.ts — 49 tests (品質監査: 拍位置/ビバップスケール/アプローチ/エンクロージャー/テンプレート構造/開始終了/VL/Musical Forces/全モード網羅/多様性/拍数適合/ポジション/実用性/接合部/リズムR.1-R.5/休符挿入/GAPレポート)
...
**テスト**: 49テスト (品質監査) + 51テスト (segments 11 + templates 15 + generator 25) + 33テスト (分析)

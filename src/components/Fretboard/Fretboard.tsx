...
export function Fretboard({ visible, selPosIds, dim, showCT, ctSet, getLabel, rootNote, guideToneInfo, voicingHighlights, onNoteClick, activePhrase, phraseAnimKey, phraseAnimSpeed, swingAmount, bpm }: FretboardProps) {
  return (

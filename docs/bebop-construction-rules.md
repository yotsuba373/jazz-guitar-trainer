...
**方向転換は拍裏で** (Barry Harris, ★★★):
- メロディの方向転換は beat 2裏, 4裏 で行う
- Beat 1, 3 での方向転換は予測可能で退屈
...
2. 表拍スロット (1, 3, 5, 7番目) に **CT** を配置 (Beat 1,3 にはガイドトーン優先)
3. ゴール音決定: 次コード3rd / 現コード7th / ユーザー指定
4. 開始拍: 裏拍 (and of 4, and of 2) にバイアス
...
| ルール | セクション | 実装方法 |
|--------|----------|---------|
| 方向転換は拍裏で | §9 | 方向変更のスケジューリング制約 |
| 下=chromatic, 上=diatonic | §3 | 方向別アプローチタイプ選択 |
| Beat 1,3 にガイドトーン | §1 | 強拍CTにガイドトーン優先 |
